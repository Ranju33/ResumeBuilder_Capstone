 ...
 *
 */
public class TC_Education_002Test extends Base_Class {
	@Test
	public void Education() {
		...
		Assert.assertEquals(download.getWord().getText(), excelLib.readStringDataFromExcel("Sheet1",0,11),"Download not Successfully in WORD formate");
		Reporter.log("Download Successfully in WORD farmate",true);
		download.getWord().click();
	}
